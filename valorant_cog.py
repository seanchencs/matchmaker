        ...
        with shelve.open(str(ctx.guild.id)) as db:
            ...
            if user:
                ...
                if len(past_ratings) < 30:
                    past_ratings = [val for val in past_ratings for _ in (0, ceil(30/len(past_ratings)))]
                ...
                if all_past_ratings and len(all_past_ratings[0]) < 30:
                    all_past_ratings = [[val for val in past_ratings for _ in (0, ceil(30/len(past_ratings)))] for past_ratings in all_past_ratings]
