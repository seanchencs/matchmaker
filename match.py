...
class Match:
    def __init__(self, players: Set[discord.User], guild_id: int, db_match=None):
    ...
    def load_match(self, match: Dict, guild_id: int):
        ...
        self.team_a_old = {k: match["old_ratings"][k] for k, _ in self.team_a_new}
        self.team_b_old = {k: match["old_ratings"][k] for k, _ in self.team_b_new}
